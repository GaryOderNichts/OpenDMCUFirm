...
void FUN_0e3b(FVIVideoMode videoMode, FVIState* state)
{
    ...
    DC_Write32(0x10A6, postBlanking | (preBlanking << 16) | 0x80008000ul);
    DC_Write32(0x10A7, uVar3 | (uVar2 << 16) | 0x80008000ul);
